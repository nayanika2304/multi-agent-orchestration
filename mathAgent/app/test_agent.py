"""
Simple pytest tests for MathAgent
"""
import pytest
...
class TestMathAgent:
    """Test suite for MathAgent"""
    
    def test_agent_initialization(self):
        """Test that MathAgent can be initialized"""
    ...
    def test_supported_content_types(self):
        ...
        assert hasattr(MathAgent, 'SUPPORTED_CONTENT_TYPES')
        assert isinstance(MathAgent.SUPPORTED_CONTENT_TYPES, list)
        assert len(MathAgent.SUPPORTED_CONTENT_TYPES) > 0
